...
export const Widgets = () => {
  return (
    <>
      <div className="container h-screen mx-auto py-10  md:w-4/5 w-11/12 px-6">
        <div className="w-full rounded border-dashed border-2 border-gray-300 ">
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-2 md:grid-cols-2 md:gap-2 lg:grid-cols-3 lg:gap-3 xl:grid-cols-4 xl:gap-4">
