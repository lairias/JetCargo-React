                        ...
                        <div className="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
                            <div className="block lg:flex xl:flex md:block items-center justify-between">
                                <div className="flex items-center">
                                    ...
                                    <a >
                                        <div className="py-2 px-4 text-gray-600 hover:text-indigo-700 hover:bg-indigo-100 rounded-full ml-4 sm:ml-8">
                                            <p>Done</p>
                                        </div>
                                    </a>
                                    <a >
                                        <div className="py-2 px-4  mr-4 text-gray-600 hover:text-indigo-700 hover:bg-indigo-100 rounded-full  sm:ml-8">
                                            <p>Pending</p>
                                        </div>
                                    </a>
