...
export default function EditNewTrackingPendiente() {
  ...
  return (
    ...
    ) : (RECEIVED_TRACKING === "RECEIVED" ? ( <Received COD_COUNTRY={COD_COUNTRY} COD_CUSTOMER={COD_CUSTOMER} RECEIVED_TRACKING={RECEIVED_TRACKING} NUM_TRACKING={NUM_TRACKING} COD_TRACKING={DataTracking.Number_tracking.COD_TRACKING} COD_ORDEN={DataOrden[0].COD_ORDEN}  />)
