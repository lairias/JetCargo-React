...
export const SelectDisplay = () => {
    ...
    return (
        <div className="relative">
            <div className="bg-white  flex justify-between border rounded w-40" onClick={() => setShow(!show)}>
                <p className="px-3 py-3 text-gray-600  text-sm leading-3 tracking-normal font-normal">Basic Options</p>
