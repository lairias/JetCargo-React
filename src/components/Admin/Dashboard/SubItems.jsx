...
export const SubItems = ({item,Dindex}) => {
  ...
  return (
    <>
      <button onClick={item.subNav && showSubnav} className="focus:outline-none focus:text-sky-400  text-gray-700 flex justify-between items-center w-full py-5 space-x-14  ">
