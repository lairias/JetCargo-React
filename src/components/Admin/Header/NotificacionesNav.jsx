...
export const NotificacionesNav = ({notification, set_notification}) => {
    return (
        <div className="w-full absolute bg-gray-500 bg-opacity-50 z-40 right-0 h-full overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700" id="notification">
            <div className="2xl:w-4/12 bg-gray-50 h-screen overflow-y-auto p-8 absolute right-0">
                <div className="flex items-center justify-between">
                    ...
                    <div className="cursor-pointer" onClick={() => set_notification(!notification)}>
