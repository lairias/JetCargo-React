        ...
        <>
            <div className="flex flex-wrap items-center justify-center  gap-7  sm:px-6 ">
                <div className="w-64 p-4  rounded border hover:shadow-lg bg-white">
                    ...
                    <p className="text-sm leading-none text-center text-gray-600 my-3">Projects done</p>
                    <div className="w-56 h-9">
                        <NavLink to={"/admin/packages/4"} role="button" aria-label="message" className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 hover:bg-gray-100 flex items-center justify-center flex-1 h-full py-3 px-20 bg-gray-50 border rounded border-gray-200">
                            <p className="text-sm font-medium leading-none text-gray-600">Seguimiento</p>
                        </NavLink>
                    </div>
                </div>
