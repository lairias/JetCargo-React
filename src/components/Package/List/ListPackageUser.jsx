  ...
  return (
    ...
    <div className="w-full">
        <div className="border rounded-xl bg-white pb-6 mb-6">
            ...
            <button onClick={handleShowInvoice} className="flex items-center justify-between w-full  px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"> Factura <span className="ml-2" >
                <FaFileInvoiceDollar />
                </span></button>
            </div>
