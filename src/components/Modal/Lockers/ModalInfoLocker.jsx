...
export default function ModalInfoLocker({ isOpen, setIsOpen, item}) {
  ...
  /********************************************************************** */
  /****************************************************Variables de Hooks */
  const [DataLocker, loaddinLocker] = useFetchToken(`phone/locker/${item.COD_LOCKER}`);
                ...
                <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                  ...
                  <div className="mt-2">
                    ...
                    <table className="w-full whitespace-nowrap">
                            ...
                            {loaddinLocker ? DataLocker.map(item=>(
                                <tr>
                                    <td>
                                        <div className="flex items-center">
                                            ...
                                            <div className="pl-3">
                                                <div className="flex items-center text-sm leading-none">
                                                    <p className="text-blue-500 ml-3">+({item.NUM_AREA})-</p>
                                                    <p className="font-semibold text-gray-800">{item.NUM_PHONE}</p>
                                                </div>
                                            </div>
