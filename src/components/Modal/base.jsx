...
//   PostCategoryPackage,
//   GetcategoryPackage,
// } from "../../../actions/categorypackageAction";
...
export default function ModalNewCatPackage({ handleShoModal }) {
  ...
  return (
    <>
      <Toaster />
      <Dialog header="Header" visible={handleShoModal} style={{ width: '50vw' }} footer={renderFooter('displayBasic2')} onHide={handleShoModal}>
