...
export default function  ModalNewCard ({handleShoModal}){
return(
    <div>
            <div className="py-12 bg-gray-500 bg-opacity-50 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0" id="modal">
                <div role="alert" className="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                    <div className="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                        <div className="w-full flex justify-start text-gray-600 mb-3" onClick={handleShoModal}>
                            X
                        </div>
                        ...
                        <div className="flex items-center justify-start w-full">
                            ...
                            <button className="focus:outline-none ml-3 bg-gray-100 transition duration-150 text-gray-600 ease-in-out hover:border-gray-400 hover:bg-gray-300 border rounded px-8 py-2 text-sm" onClick={handleShoModal}>
                                Cancel
                            </button>
                        </div>
