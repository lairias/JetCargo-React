...
<div className="mx-auto container">
  <div className="flex items-center justify-center h-full w-full">
    <div className="bg-white rounded-md shadow fixed overflow-x-auto sm:h-auto w-10/12 md:w-8/12 lg:w-2/3 xl:w-2/3">
      ...
      <p className="text-base font-semibold">Editar rol - {loading ? (typeUsesState.role.NOM_TYPE) : ( <SpinerLoader /> )} </p>
                <button onClick={handleShoweditModal} className="focus:outline-none">
          <svg
            width={28}
            height={28}
            viewBox="0 0 28 28"
