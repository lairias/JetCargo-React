...
import { PostCategoryPackage,GetcategoryPackage } from '../../../actions/categorypackageAction';
import { Toaster } from 'react-hot-toast';
import { useEffect } from 'react';

export default function ModalNewCatPackage({ handleShoModal,_id }) {
    /********************************Variables de State */
    ...
    useEffect(() => {
        dispatch(GetcategoryPackage(_id));
    })
    /************************************************** */
          ...
          <div className="flex items-center justify-center h-full w-full">
            <div className="bg-white rounded-md shadow fixed overflow-y-auto sm:h-auto w-10/12 md:w-8/12 lg:w-1/2 2xl:w-2/5">
              <div className="bg-gray-100 rounded-tl-md rounded-tr-md px-4 md:px-8 md:py-4 py-7 flex items-center justify-between">
                <p className="text-base font-semibold">Nueva categoria de paquetes</p>
